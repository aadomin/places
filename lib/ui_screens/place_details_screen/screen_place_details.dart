...
class _ScreenPlaceDetailsState extends State<ScreenPlaceDetails> {
  ...
  Widget build(BuildContext context) {
    ...
    final int ___countOfPhotos = ___sight.urls.length;
                        ...
                        for (var i = 0; i < ___countOfPhotos; i++)
                          SizedBox(
                            ...
                            child: Builder(builder: (context) {
                              String urlItem = ___sight.urls.isNotEmpty
                                  ? ___sight.urls[i]
                                  : '';

                              debugPrint(urlItem + ___sight.name);

                              if (i == 0) {
                                return Hero(
                                  
                                  tag: urlItem + ___sight.name,
                                  child: WidgetMyImage(
                                    url: urlItem,
                                    fit: BoxFit.cover,
                                  ),
